...
import pers.acp.client.exceptions.FTPException;
...
public class FtpClient extends BaseClient {
    ...
    private FtpConnectMode connectMode = FtpConnectMode.ACTIVE_LOCAL;
    ...
    public String getActiveServerHost() {
        return activeServerHost;
    }

    public void setActiveServerHost(String activeServerHost) {
        this.activeServerHost = activeServerHost;
    }
    ...
    public void setActiveServerPort(int activeServerPort) {
        this.activeServerPort = activeServerPort;
    }
        ...
        try {
            ...
            switch (connectMode) {
                case ACTIVE_LOCAL:
                    ...
                    break;
                case ACTIVE_REMOTE:
                    ftpClient.enterRemoteActiveMode(InetAddress.getByName(activeServerHost), activeServerPort);
                    break;
                case PASSIVE_LOCAL:

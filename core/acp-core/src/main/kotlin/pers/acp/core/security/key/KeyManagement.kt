...
object KeyManagement {
     ...
     */
    @Throws(Exception::class)
    private fun getEntity(keyType: KeyType, cryptType: String = HMACUtils.CRYPT_TYPE, traitId: String, length: Int = 0): KeyEntity =
            KeyEntity.generateEntity(keyType, cryptType, traitId, length)

    private fun decodeUInt32(key: ByteArray, start_index: Int): Int {
        val test = Arrays.copyOfRange(key, start_index, start_index + 4)

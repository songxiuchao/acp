package pers.acp.springcloud.config.test;
...
import pers.acp.springcloud.config.ConfigServerApplication;
import pers.acp.springcloud.config.entity.Properties;
import pers.acp.springcloud.config.repo.PropertiesRepository;
